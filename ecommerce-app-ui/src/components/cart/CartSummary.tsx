    ...
    <aside className="relative z-10 rounded-md border border-light-open-gray bg-white p-5 shadow-sm">
      ...
      <div className="space-y-3 text-sm">
        <div className="flex items-center justify-between">
          <span className="font-medium text-gray-light">Ürünler Toplamı</span>
        ...
        <div className="flex items-center justify-between">
          <span className="font-medium text-gray-light">Kargo Ücreti</span>
          <span className="font-bold text-primary">
        ...
        <div className="flex items-center justify-between">
          <span className="font-medium text-gray-light">İndirim</span>
